...
async def get_all_transactions(db: _orm.Session = _fastapi.Depends(_utils.get_db)):
...
async def get_user_transactions(user_id: int, db: _orm.Session = _fastapi.Depends(_utils.get_db)):
...
async def create_transactions(transactions_details: _schemas.UserTransaction, db: _orm.Session = _fastapi.Depends(_utils.get_db)):
